                  ...
                  <tbody className='bg-white divide-y divide-gray-200 '>
                   {
                    bids.map(bid=>(
                        ...
                        <td className='px-4 py-4 text-sm whitespace-nowrap'>
                          ...
                          <p
                            className={`px-3 py-1 rounded-full ${bid.category === 'Web Development' && ' text-blue-500 bg-blue-100/60'} ${bid.category === 'Digital Marketing' && ' text-rose-500 bg-green-100/60'} ${bid.category === 'Graphics Design' && ' text-blue-500 bg-rose-100/60'}
                            text-xs`}
                          >
                            {bid.category}
                          </p>
